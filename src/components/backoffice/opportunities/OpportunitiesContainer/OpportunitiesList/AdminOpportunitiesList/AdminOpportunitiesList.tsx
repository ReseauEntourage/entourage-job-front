...
import { StyledLinkCard, StyledListContent, StyledListItem, StyledListItemContainer } from '../OpportunitiesList.styles';
import Link from 'next/link';
import { CandidateOpportunityItem } from '../CandidateOpportunitiesList/CandidateOpportunityItem';
...
export const AdminOpportunitiesList = ({
    ...
    return (
        <StyledListContent
            data-testid="admin-offer-list-container" 
        >
