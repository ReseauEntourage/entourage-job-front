      ...
      <Grid column middle eachWidths={['2-3@m', '1-1']}>
        <div className="uk-text-center">
          {process.env.WOMENS_DAY === 'true' ? (
            <>
              <H2 title="Elles sont motivées pour travailler" center color="black"/>
              <Typography size="large">
                Découvrez les derniers CV des nos candidates et partagez-les pour leur donner la visibilité qu'elles méritent !
              </Typography>
            </>
          ) : (
            <>
              <H2 title="Ils sont motivés pour travailler" center color="black"/>
              <Typography size="large">
                Découvrez les derniers CV des nos candidat(e)s et partagez-les pour leur donner la visibilité qu'ils méritent !
              </Typography>
            </>
          )}
          {process.env.WOMENS_DAY === 'true' && (
            <H4
              title={<>À l&apos;occasion du 8 mars,{' '}
