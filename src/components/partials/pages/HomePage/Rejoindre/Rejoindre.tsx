        ...
        cards={[
            {
                ...
                description: "Vous avez besoin d'aide ? Notre communauté de coachs met son expertise à votre disposition pour vous proposer l'accompagnement qu'il vous faut.",
            ...
            {
                title: "Je veux aider",
                description: "Vous souhaitez accompagner nos candidat(e)s dans leur retour à l'emploi et donner du sens à votre expérience ? C'est ici que ça se passe !",
