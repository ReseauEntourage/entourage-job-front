    ...
    >
      ...
      <div data-uk-scrollspy="cls:uk-animation-slide-bottom; target: > p; delay: 200;">
        ...
        <p>
          ...
          rencontres avec des professionnels pour bénéficier d’un coup de pouce
          (conseil, contact, simulation d’entretien)
        </p>
        <p>
          <strong>L’utilisation de la plateforme Entourage Pro</strong> pour
          créer le CV, le publier, accéder aux offres d’emploi et y répondre.
        </p>
      </div>
      <Button
