...
const content = [
    {
        ...
        paragraph: "Relecture du parcours du candidat et formalisation des envies professionnelles",
    ...
    },
    {
        ...
        paragraph: "Préparation aux entretiens d'embauche et soutien des candidatures",
        src: '/static/img/orienter-emploi.png',
    },
    {
        title: "Facilitation de l’intégration en entreprise",
        paragraph: "Faciliter les échanges avec le recruteurs dans la phase d'intégration et soutenir le candidat dans sa prise de poste",
        src: '/static/img/orienter-calendrier.png',
    },
]


export const Programme360 = ({ innerRef }: { innerRef?: Ref<HTMLDivElement> }) => {
            ...
            >
                ...
                >
                    <li>
                        ...
                        <div>Durée de 6 mois</div>
                    </li>
                    <li>
                        <OrienterSablier {...iconsProps} />{' '}
                        <div>2 heures par semaine</div>
                    </li>
                    <li>
                ...
                <div data-uk-scrollspy="cls:uk-animation-slide-bottom; target: > p; delay: 200;">
                    <p>
                        Le programme 360 vous propose un accompagnement personnalisé de 6 mois avec un coach dédié.
                    </p>
                    <p>
                        Votre coach vous accompagnera tout au long de votre recherche d’emploi. <br/> Nos équipes sont formées pour faire matcher des profils compatibles et que vous puissiez bénéficier de l’accompagnement le plus efficace possible. 
                    </p>
                    <p>
                        Vous pourrez compter sur votre coach pour vous conseiller notamment sur les thématiques suivantes :
                    </p>
                    <StyledProgrammesList
                        data-uk-scrollspy="cls:uk-animation-slide-bottom; target: > li; delay: 200;"
                    >
