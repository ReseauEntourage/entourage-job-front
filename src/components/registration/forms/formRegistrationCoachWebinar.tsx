  ...
  fields: [
    {
      id: 'infoCoSubtitle',
      name: 'infoCoSubtitle',
      title: `Les réunions ont lieu en visio. Elles permettent à nos équipes de vous donner toutes les informations et conseils nécessaires pour débuter le programme 360.`,
      component: 'text',
    },
    {
      id: 'campaign',
