...
const STRATEGY = [
  ...
  },
  {
    ...
    question:
      'Comment décrire le partenariat, la collaboration entre votre structure et Entourage Pro\xa0?',
    answer:
      'Avec la Course Au Changement, nous avons tissé des liens très forts et étroits entre nos organisations et nos équipes.\n\n' +
      "Nous sommes très heureux de contribuer au développement d'Entourage Pro, à la lutte contre la grande exclusion en France et, nous le souhaitons, au retour à l’emploi de milliers de personnes qui le méritent tant.",
  ...
  },
  {
    ...
    question: "Quel est, pour vous, la force d'Entourage Pro\xa0?",
    answer:
  ...
  },
  {
    ...
    answer:
      'Randstad apporte son expertise RH et sa parfaite connaissance des bassins d’emploi, pour structurer et sécuriser les parcours des candidats Entourage Pro vers l’emploi durable\xa0: de l’accueil  à l’intégration et de l’accompagnement au maintien en emploi.',
  ...
  },
  {
    ...
    question:
      "Pourquoi avoir eu envie de vous engager aux côtés d'Entourage Pro\xa0?",
    answer:
  ...
  },
  {
    ...
    question: 'Que représente pour vous le projet Entourage Pro\xa0?',
    answer:
      'Entourage Pro c’est un tremplin vers l’inclusion\xa0: pour les entreprises qui cherchent à recruter des profils variés, pour les candidats qui pourront s’épanouir dans leur travail, et pour nous toutes et tous, qui pouvons agir simplement, en partageant un CV.',
...
const ALL_FINANCE = [
  ...
  },
  {
    ...
    /*
        question: 'Que souhaitez-vous à Entourage Pro\xa0?',
...
const ASSOCIATIONS = [
  ...
  },
  {
    ...
    desc:
      ...
      "Les candidats Entourage Pro qui le souhaitent seront préparés par La Cravate Solidaire aux entretiens d'embauche et recevront une tenue d’entretien, la chance\xa0!",
