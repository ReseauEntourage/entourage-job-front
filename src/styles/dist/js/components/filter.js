...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define('uikitfilter', ['uikit-util'], factory)
      : ((global =
    ...
    methods: {
      ...
      getState: function () {
        ...
        return this.toggles
          .filter(function (item) {
            return uikitUtil.hasClass(item, this$1$1.cls);
          })
          .reduce(
            function (state, el) {
      ...
      setState: function (state, animate) {
        ...
        uikitUtil.Promise.all(
          uikitUtil.$$(this.target, this.$el).map(function (target) {
          ...
          return uikitUtil.trigger(this$1$1.$el, 'afterFilter', [this$1$1]);
        });
      },
  ...
  function isEqualState(stateA, stateB) {
    return ['filter', 'sort'].every(function (prop) {
      return uikitUtil.isEqual(stateA[prop], stateB[prop]);
    });
  }
  ...
  function applyState(state, target, children) {
    ...
    children.forEach(function (el) {
      return uikitUtil.css(
        el,
        'display',
        selector && !uikitUtil.matches(el, selector) ? 'none' : ''
      );
    });
  ...
  function getSelector(ref) {
    ...
    var selector = '';
    uikitUtil.each(filter, function (value) {
  ...
  function sortItems(nodes, sort, order) {
    return uikitUtil.assign([], nodes).sort(function (a, b) {
      return (
        uikitUtil
          .data(a, sort)
          .localeCompare(uikitUtil.data(b, sort), undefined, {
            numeric: true,
          }) * (order === 'asc' || -1)
      );
    });
