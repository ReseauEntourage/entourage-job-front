      ...
      setState: function (o, t) {
        ...
        function e() {
          ...
          c.forEach(function (t) {
            return u.css(t, 'display', i && !u.matches(t, i) ? 'none' : '');
          });
          var n,
            r,
            t = (a = o.sort)[0],
          ...
          t &&
            ((n = t),
            (r = a),
            (a = u.assign([], c).sort(function (t, e) {
              return (
                u
                  .data(t, n)
                  .localeCompare(u.data(e, n), void 0, { numeric: !0 }) *
                ('asc' === r || -1)
              );
            })),
            u.isEqual(a, c) ||
