        ...
        return new uikitUtil.Promise(function (resolve) {
          return uikitUtil.Promise.all(
            uikitUtil.toNodes(targets).map(function (el) {
              var show = uikitUtil.isBoolean(toggle)
                ? toggle
                : !this$1$1.isToggled(el);

              if (
                !uikitUtil.trigger(el, 'before' + (show ? 'show' : 'hide'), [
                  this$1$1,
                ])
              ) {
        ...
        handler: function () {
          ...
          if (this.stack) {
            uikitUtil.css(
              this.$el,
              'zIndex',
              uikitUtil.toFloat(uikitUtil.css(this.$el, 'zIndex')) +
                active.length
            );
          }
          ...
          if (this.bgClose) {
            uikitUtil.once(
              ...
              uikitUtil.on(document, uikitUtil.pointerDown, function (ref) {
                ...
                if (
                  uikitUtil.last(active) !== this$1$1 ||
                  (this$1$1.overlay &&
                    !uikitUtil.within(target, this$1$1.$el)) ||
                  uikitUtil.within(target, this$1$1.panel)
                ) {
                  return;
                }
    ...
    methods: {
      startAutoplay: function () {
        ...
        this.interval = setInterval(function () {
          return (
            (!this$1$1.draggable || !uikitUtil.$(':focus', this$1$1.$el)) &&
            (!this$1$1.pauseOnHover ||
              !uikitUtil.matches(this$1$1.$el, ':hover')) &&
  ...
  var SliderDrag = {
    ...
    methods: {
      start: function () {
        ...
        uikitUtil.on(
          document,
          uikitUtil.pointerUp + ' ' + uikitUtil.pointerCancel + ' input',
          this.end,
          true
        );
        ...
        if (this.nav && this.length !== this.nav.children.length) {
          uikitUtil.html(
            ...
            this.slides
              .map(function (_, i) {
                return (
                  '<li ' + this$1$1.attrItem + '="' + i + '"><a href></a></li>'
                );
              })
              .join('')
          );
