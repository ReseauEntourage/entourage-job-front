              ...
              if (!m.isUndefined(f[e])) {
                var r,
                  ...
                  l =
                    (l && m.css(h, e, ''),
                    p.length < 2 &&
                      p.unshift(('scale' === e ? 1 : l ? m.css(h, e) : 0) || 0),
                ...
                if (
                  (u
                    ...
                    ? ((a = 'bgy' === e ? 'height' : 'width'),
                      ...
                      (r = g.covers
                        ? ((s = Math.min.apply(Math, p)),
                          (n = Math.max.apply(Math, p)),
                          (o = p.indexOf(s) < p.indexOf(n)),
                          (c = n - s),
                          (p = p.map(function (t) {
                            return t - (o ? s : n);
                          })),
                ...
                t[e] = { steps: p, unit: l, pos: r, bgPos: i, diff: c };
              }
              return t;
            }, {});
          },
    ...
    update: {
      read: function (t, e) {
        ...
        if (('scroll' !== e && (i = !1), t.active))
          return (
            (e = i),
            (t = m.scrolledOver(this.target) / (this.viewport || 1)),
            (r = this.easing),
            {
              percent: (i = m.clamp(t * (1 - (r - r * t)))),
              style: e !== i && this.getCss(i),
            }
          );
      },
      write: function (t) {
        var e = t.style;
        t.active ? e && m.css(this.$el, e) : this.reset();
      },
