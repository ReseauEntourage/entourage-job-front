              ...
              if (!g.isUndefined(f[e])) {
                var i,
                  ...
                  l =
                    (l && g.css(p, e, ''),
                    h.length < 2 &&
                      h.unshift(('scale' === e ? 1 : l ? g.css(p, e) : 0) || 0),
                ...
                if (
                  (u
                    ...
                    ? ((n = 'bgy' === e ? 'height' : 'width'),
                      ...
                      (r = g.css(p, 'backgroundPosition').split(' ')[
                        'x' === e[2] ? 0 : 1
                      ]),
                      (i = m.covers
                        ? ((s = Math.min.apply(Math, h)),
                          (a = Math.max.apply(Math, h)),
                          (o = h.indexOf(s) < h.indexOf(a)),
                          (c = a - s),
                          (h = h.map(function (t) {
                            return t - (o ? s : a);
                          })),
                ...
                t[e] = { steps: h, unit: l, pos: i, bgPos: r, diff: c };
              }
              return t;
            }, {});
          },
      ...
      },
      {
        ...
        handler: function (t) {
          ...
          g.Transition.cancel(this.$el),
            g.css(this.$el, this.getCss(a(e, t, i))),
            g.Transition.start(
              this.$el,
              this.getCss(s(e) ? 0.5 : 0 < t ? 1 : 0),
              r,
              n
            ).catch(g.noop);
        },
