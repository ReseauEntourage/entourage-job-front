...
(function (global, factory) {
    ...
    methods: {
      animate: function (action) {
        ...
        children = children.concat(
          uikitUtil.children(this.target).filter(function (el) {
            return !uikitUtil.includes(children, el);
          })
        );
  ...
  var Component = {
    ...
    update: {
      write: function () {
        ...
        if (
          !sortable ||
          uikitUtil.within(target, this.placeholder) ||
        ...
        target =
          ...
          sortable.items.filter(function (element) {
            return uikitUtil.within(target, element);
          })[0];
    ...
    methods: {
      ...
      move: function (e) {
        ...
        this.touched.forEach(function (sortable) {
          return uikitUtil.removeClass(sortable.items, classes);
        });
      ...
      insert: function (element, target) {
        ...
        var insert = function () {
          if (target) {
            if (
              !uikitUtil.within(element, this$1.target) ||
  ...
  function isPredecessor(element, target) {
    return (
      ...
      uikitUtil.index(element) > uikitUtil.index(target)
    );
  }
  ...
  function appendDrag(container, element) {
    ...
    uikitUtil.attr(
      clone,
      'style',
      uikitUtil.attr(clone, 'style') + ';margin:0!important'
    );
