...
(function (global, factory) {
  ...
  var Component = {
    ...
    methods: {
      show: function () {
        ...
        this._unbind = uikitUtil.once(
          document,
          'show keydown ' + uikitUtil.pointerDown,
          this.hide,
          false,
          function (e) {
            return (
              (e.type === uikitUtil.pointerDown &&
                !uikitUtil.within(e.target, this$1$1.$el)) ||
              (e.type === 'keydown' && e.keyCode === 27) ||
              (e.type === 'show' &&
                e.detail[0] !== this$1$1 &&
                e.detail[0].$name === this$1$1.$name)
            );
          }
        );
    ...
    events:
      ...
      (obj[uikitUtil.pointerEnter + ' ' + uikitUtil.pointerLeave] = function (
        e
      ) {
