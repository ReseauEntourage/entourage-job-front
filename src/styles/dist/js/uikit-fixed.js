      ...
      this._watch = fastdom.read(function () {
        ...
        for (var key in computed) {
          ...
          if (
            watch &&
            ((initital && immediate) ||
              (hasPrev && !isEqual(prev, this$1$1[key])))
          ) {
        ...
        return new Promise$1(function (resolve) {
          return Promise$1.all(
            toNodes(targets).map(function (el) {
              ...
              if (
                !trigger(el, 'before' + (show ? 'show' : 'hide'), [this$1$1])
              ) {
        ...
        items.forEach(function (el) {
          return this$1$1.toggleElement(
            ...
            function (el, show) {
              ...
              hide(content, false);
              return toggleHeight(this$1$1)(el._wrapper, show).then(
                function () {
                  hide(content, !show);
                  delete el._wrapper;
                  unwrap(content);
    ...
    methods: {
      getSvg: function () {
        ...
        return loadSVG(this.src).then(function (svg) {
          return (
            parseSVG(svg, this$1$1.icon) || Promise$1.reject('SVG not found.')
          );
        });
      },
          ...
          if (this.bgClose) {
            once(
              ...
              on(document, pointerDown, function (ref) {
                ...
                if (
                  last(active) !== this$1$1 ||
                  (this$1$1.overlay && !within(target, this$1$1.$el)) ||
                  within(target, this$1$1.panel)
                ) {
                  return;
                }
    ...
    events: [
...

      {
        ...
        handler: function (e) {
          ...
          // FIX : Removed for now because of bug where we can't touch scroll on Offcanvas
          /*
    ...
    methods: {
      toggle: function (type) {
        ...
        this.toggleElement(toggled, false).then(function () {
          return this$1$1.toggleElement(
            this$1$1.target.filter(function (el) {
        ...
        this.navItems.forEach(function (el) {
          ...
          if (index !== false) {
            el.hidden =
              ...
              (this$1$1.sets && !includes(this$1$1.sets, index));
          }
        });
    ...
    methods: {
      show: function () {
        ...
        this._unbind = once(
          ...
          function (e) {
            return (
              (e.type === pointerDown && !within(e.target, this$1$1.$el)) ||
